...
var xpath =  querySelectorShadowDom.querySelectorDeep('span[title="Opened for"]',tag);
xpath.innerHTML = 'Please wait...<img src="/images/loading_anim2.gif" alt="Loading..." />             ' ;
...
xpath.textContent = ' ✅✅✅ Successfully copied info of ' +name;
...
iframe2 = document.createElement('iframe');
   ...
   `;
   iframe2.id="refreshframe";
iframe2.style.top = "234px";
iframe2.style.left= '322px';
iframe2.style.width = '500px';
iframe2.style.height = '140px';
iframe2.style.backgroundColor = 'RGB(var(--now-alert--positive--background-color,var(--now-color_alert--positive-0,201,224,202)))';
iframe2.style.borderColor = 'RGB(var(--now-alert--positive--border-color,var(--now-color_alert--positive-1,119,178,123)))' ;
iframe2.style.zIndex ="1000";
iframe2.style.scrolling="no";
...
var xpath =  querySelectorShadowDom.querySelectorDeep('span[title="Location"]',tag2);
xpath.innerHTML = 'Please wait...<img src="/images/loading_anim2.gif" alt="Loading..." />  ';        
...
fetch(url2)
  ...
  .then(html => {
    ...
    console.log(copyText);
      ...
      xpath.textContent = ' ✅✅✅ Successfully copied Location: ' +copyText;
